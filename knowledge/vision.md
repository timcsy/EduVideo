...
目前的 Studio 0.8.0 實作包含瀏覽器式錄製工作區、投影片標記、講者合成、非破壞性時間軸剪輯、素材管理、.eduv 資料夾專案、可編輯字幕與辨識路徑，以及可選用原生語音模型的 Electron 桌面執行環境。桌面工具支援與工作室互斥顯示、固定錄製控制、獨立人像預覽、準備來源切換與簡報頁面管理；重播與字幕時間修正已有自動化測試涵蓋。
